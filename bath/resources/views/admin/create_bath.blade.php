...
<section class="text-gray-600 body-font">
    <div class="mt-7 hover:bg-gray-200" style="position: absolute; top: 10px; right: 100px;">
        <a href="{{ route('admin.bath.index') }}">あとで</a>
    </div>
        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex lg:w-2/3 text-center w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
                <div class="relative flex-grow w-full">
                    <label for="name" class="leading-7 text-sm text-gray-900">施設名 ※必須</label>
