...
<div class="relative">
    ...
    <div class="container px-5 py-24 mx-auto relative z-10">
        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <section class="温泉の魅力">
                <div class="text-lg hdg-top-b" style="position: relative;">
                    <div class=" flex-container" style="display: flex; justify-content: center;">
                        <img class="" src="{{ asset('images/24149431.jpg')}}" alt="温泉の魅力" style="width: 200px; height: auto; opacity: 0.5;">
                        <h1 class="--txt" style="position: absolute; top: 10%; left: 50%; transform: translate(-50%, -50%); padding: 10px; border-radius: 5px;">
                        ~温泉の魅力~
                        </h1>
                    </div>
                </div>
            ...
            <section class="text-white py-24 mt-12">
                <div class="container px-5 py-8 mx-auto flex items-center flex-col" style="background-image: linear-gradient(to bottom, #f6cb7a, #FF6347);">
                    ...
                    <a href="{{ route('user.register') }}" rel="noopener noreferrer" target="_blank">
