...
<div class="relative">
    ...
    <div class="container px-5 py-6 mx-auto relative z-10">
        <h1 class="text-3xl mb-4">利用規約</h1>
        <p>この利用規約（以下「本規約」といいます。）は、バスクリプション（以下「当社」といいます。）がこのウェブサイト上で提供するバスクリプション（以下「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。</p>
        <section>
            <h2 class="text-2xl mt-16 mb-4">第1条（適用）</h2>
            <ul>
        ...
        <section>
            <h2 class="text-2xl mt-8 mb-4">第2条（利用登録）</h2>
            <ul>
        ...
        <section>
            <h2 class="text-2xl mt-8 mb-4">第3条（ユーザーIDおよびパスワードの管理）</h2>
            <ul>
        ...
        <section>
            <h2 class="text-2xl mt-8 mb-4">第4条（利用料金および支払方法）</h2>
            <ul>
                ...
                <li>ユーザーは、本サービスを利用後、施設が設定する利用条件を満たさなかった場合、施設の求めに応じ、無料となった入館料等を施設に支払うものとします。</li>
            </ul>
        </section>
        <section>
            <h2 class="text-2xl mt-8 mb-4">第5条（禁止事項）</h2>
        ...
        <section>
            <h2 class="text-2xl mt-8 mb-4">第6条（本サービスの提供の停止等）</h2>
            <ul>
                <li>当社は、以下のいずれかの事由があると判断した場合、ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。<ul>
        ...
        <section>
            <h2 class="text-2xl mt-8 mb-4">第7条（利用制限および登録抹消）</h2>
            <ul>
        ...
        <section>
            <h2 class="text-2xl mt-8 mb-4">第8条（退会）</h2>
            <p>ユーザーは、当社の定める退会手続により、本サービスから退会できるものとします。</p>
        </section>
        <section>
            <h2 class="text-2xl mt-8 mb-4">第9条（保証の否認および免責事項）</h2>
            <ul>
        ...
        <section>
            <h2 class="text-2xl mt-8 mb-4">第14条（権利義務の譲渡の禁止）</h2>
            <p>ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</p>
        </section>
        <section>
            <h2 class="text-2xl mt-8 mb-4">第15条（準拠法・裁判管轄）</h2>
