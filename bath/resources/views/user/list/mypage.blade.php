    ...
    <div class="absolute top-4 right-4">
      ...
      <div class="flex flex-wrap -m-4">
        <div class="xl:w-1/3 md:w-1/2 p-4">
          <div class="border hover:bg-gray-400 border-gray-900 p-6 rounded-lg" style="opacity: 0.8;">
        ...
        <div class="xl:w-1/3 md:w-1/2 p-4">
          <div class="border hover:bg-gray-400 border-gray-900 p-6 rounded-lg"  style="opacity: 0.8;">
            ...
            <h2 class="text-lg text-gray-900 font-medium title-font mb-2 text-center hover:bg-yellow-600">カート情報</h2>
            </a>
