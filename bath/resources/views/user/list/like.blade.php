    ...
    <div class="relative">
        ...
        <div class="container px-5 py-24 mx-auto relative z-10">
            ...
            <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 bg-blue-100 text-gray-900">いいねした施設</h1>
                <div class="container px-5 py-24 mx-auto">
                    @if (count($likes) > 0)
                        @foreach ($likes as $like)
                            <div class="bg-gray-400 mb-12 mt-24 p-6 text-gray-900 dark:text-gray-100">
                                <div class="bg-blue-100 pt-16 pb-24 rounded text-center relative">
