                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="-m-2">
                                    ...
                                    <div class="p-2 w-full flex justify-around mt-6">
                                        <button onclick="location.href='{{route('manage.admin.index')}}' " class="bg-gray-100 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
                                        <button class="text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">登録</button>
                                    </div>
                                </div>
                            </div>
                        </div>
