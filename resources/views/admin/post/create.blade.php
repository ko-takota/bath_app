        ...
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center justify-center">
            ...
            <form action="{{route('admin.post.store')}}" method="POST">
                ...
                <div class="relative mb-4">
                    ...
                    <p class="w-full bg- rounded border border-gray-300 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$bathName}}</p>
                </div>
                <div class="relative mb-4">
                ...
                <div class="p-2 w-full flex justify-around mt-6">
                    <button type="button" onclick="location.href='{{route('admin.post.index')}}' " class="bg-gray-100 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
