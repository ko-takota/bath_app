<x-app-layout>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center justify-center">
            ...
            <h1 class="text-gray-900 text-lg font-medium title-font mb-5">お知らせ作成</h1>
            <form action="{{route('manage.news.store')}}" method="POST">
                ...
                <input type="text" id="title" name="title" class="w-full bg-white rounded border border-gray-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                <div class="relative mb-4">
