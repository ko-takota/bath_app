    ...
    <div class="absolute top-4 right-64">
      ...
      <div class="flex flex-wrap -m-4">
        <div class="xl:w-1/3 md:w-1/2 p-4">
          <div class="border hover:bg-gray-400 bg-gray-300 border-gray-900 p-6 rounded-lg" style="opacity: 0.8;">
            ...
            <h2 class="text-lg text-gray-900 font-medium title-font mb-2 text-center hover:bg-yellow-300">トップ一覧へ</h2>
            </a>
        ...
        <div class="xl:w-1/3 md:w-1/2 p-4">
          <div class="border hover:bg-gray-400 bg-gray-300 border-gray-900 p-6 rounded-lg"  style="opacity: 0.8;">
            ...
            <h2 class="text-lg text-gray-900 font-medium title-font mb-2 text-center hover:bg-yellow-300">施設を探しに行く</h2>
            </a>
        ...
        <div class="xl:w-1/3 md:w-1/2 p-4">
          <div class="border hover:bg-gray-400 bg-gray-300 border-gray-900 p-6 rounded-lg"  style="opacity: 0.8;">
            ...
            <h2 class="text-lg text-gray-900 font-medium title-font mb-2 text-center hover:bg-yellow-300">投稿</h2>
            </a>
